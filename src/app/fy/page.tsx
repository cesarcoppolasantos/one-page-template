...
export default function FyPage() {
  ...
  const letterData = {
    signerName: 'John Doweqdasdawsdawsdawsdw',
    recipientName: 'Jane Smifasdfasdfasdkfasiodfjaiojfadjsiojdaiojsdoaijsdijasodjth',
    image: 'https://placehold.co/1920x1080?text=Letter+Image',
    message: 'This is a sample message that will be populated by the backend. It can contain multiple lines and will be displayed in a beautiful letter format.'
  };

  return (
    <div className="min-h-[calc(100vh-150px)] bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 p-4 relative overflow-hidden flex items-center justify-center">
      ...
      <div className="max-w-4xl mx-auto relative z-10 w-full">
        ...
        {/* Letter Display */}
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 max-w-2xl mx-auto shadow-2xl transform hover:scale-105 transition-all duration-500">
          ...
          <div className="relative space-y-4">
            ...
            <div className="text-left transform hover:translate-x-2 transition-transform duration-300">
                <div className="text-white text-lg font-medium bg-gradient-to-r from-white to-purple-200 bg-clip-text text-transparent flex justify-start items-center">
                    <span className="text-purple-300 text-sm w-16 text-right flex items-center justify-end">
                    <span className="mr-1">✨</span>From:
                    </span>
                    <span className="min-w-40 ml-5 text-left white-space-nowrap">{letterData.signerName}</span>
                </div>
                </div>

                {/* Recipient's Name */}
                <div className="text-left transform hover:translate-x-2 transition-transform duration-300 mb-8">
                <div className="text-white text-lg font-medium bg-gradient-to-r from-white to-purple-200 bg-clip-text text-transparent flex justify-start items-center">
                    <span className="text-purple-300 text-sm w-16 text-right flex items-center justify-end">
                    <span className="mr-1">💌</span>To:
                    </span>
                    <span className="min-w-40 ml-5 text-left white-space-nowrap">{letterData.recipientName}</span>
                </div>
                </div>
            ...
            <div className="text-center transform hover:scale-105 transition-transform duration-300">              
              <div className="relative group">
                <img 
                  ...
                  className="w-full max-w-md h-auto mx-auto rounded-lg shadow-lg group-hover:shadow-2xl transition-shadow duration-300 object-cover object-center"
                  style={{
                    maxHeight: '400px',
                    width: '100%',
                    height: 'auto',
            ...
            {/* Message */}
            <div className="text-center transform hover:scale-105 transition-transform duration-300">
              <div className="text-white text-lg whitespace-pre-wrap leading-relaxed font-light italic">
                "{letterData.message}"
              </div>
            </div>
          </div>
